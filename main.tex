...
\centering
\hspace*{0.1\textwidth}
{\Large Candidato} \hspace*{0.4\textwidth} {\Large Relatore}
\hspace*{0.1\textwidth}
}
...
\centering
%\hspace*{\fill}
{\huge Rossi Filippo} \hspace*{0.1\textwidth} \begin{minipage}[c]{0.5\textwidth}\huge Prof.sa Scilla Degl'Innocenti\end{minipage}
%\hspace*{\fill}
}
