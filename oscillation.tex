...
\end{equation}
dove $V_{nl}^2$ indica la velocit\'a quadratica media superficiale e ho definito l'inerzia normalizzata e la massa di un modo:
\begin{align}
...
&\delta r|_{rms}^2=\frac{1}{2}|\xi_r|^2=\frac{1}{\Pi}\int_0^{\pi}\,dt\frac{1}{4\pi}\oint\Re{\xi_rY_{l,m}(\theta,\phi)\exp{-i\omega t}}^2\,d\Omega\\
&\delta h_{rms}^2=\exv{|\vec{\xi}_h|^2}=\frac{1}{2}l(l+1)|\tilde{\xi}_h(r)|^2%=\frac{\delta h|_{rms}}{\delta r|_{rms}}=\frac{\sqrt{l(l+1)}}{\sigma}
\end{align}
...
\begin{equation}
M_{nl}[\TtwoDy{t}{M_{nl}}+\Gamma_{nl}\TDy{t}{M_{nl}}+\omega_0^2M_{nl}]=f(t)
\end{equation}
