...
I modi osservabili pi\'u facilmente hanno periodo attorno ai $\nu\approx\SI{5}{\minute}$ ci\'o \'e dovuto all'aumento del rumore solare a basse frequenze e ai processi di eccitazione dei modi che trasferiscono la massima energia.
...
\begingroup
\color{midnightblue}
$\frac{\Delta\lambda}{\lambda}\approx\num{e-10}$ doppler resonant scattering cell
velocit\'a dirretta approx radialmente: I modi relativi alle oscillazioni dei 5 minuti di grado l non elevato causano uno spostamento quasi totalmente radiale: il segnale \'e proporzionale alla velocit\'a proiettata lungo la linea di vista. 
\endgroup
...
&\Delta k_x=\frac{2\pi}{L_x}\leq k_x\leq\frac{\pi}{\Delta x},\ \Delta k_y=\frac{2\pi}{L_x}\leq k_y\leq\frac{\pi}{\Delta y}
\end{align}

Considero la geometria sfrerica descrivendo la dipendenza spaziale prendendo l'asse delle armoniche sferiche sul piano del cielo ortogonale alla linea di vista, il segnale Doppler osservato \'e proporzionale a
...
La trasformata di Fourier di $V_{l_0m_0}(t)$ permette di isolare i modi come picchi nello spettro di potenza $P(\omega,l,m)=|A_{nlm}|^2(\omega)$:
...
Le deviazioni dalla simmetria sferica causano uno splitting delle frequenze: rappresento un multipletto di frequenze tramite
\begin{equation}
