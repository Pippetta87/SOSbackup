...
\node[name=helium, right= 2mm of hydrogen] {\tiny He};
\node[name=carbonium, right= 2mm of helium] {\tiny C};
\node[name=nitrum, right= 2mm of carbonium] {\tiny N};
\node[name=oxygen, right= 2mm of nitrum] {\tiny O};
\node[name=neon, right= 2mm of oxygen] {\tiny Ne};
\node[name=sodium, right= 2mm of neon] {\tiny Na};
\node[name=magnesium, right= 2mm of sodium] {\tiny Mg};
\node[name=alluminium, right= 2mm of magnesium] {\tiny Al};
\node[name=silicium, right= 2mm of alluminium] {\tiny Si};
\node[name=sulfur, right= 2mm of silicium] {\tiny S};
\node[name=argon, right= 2mm of sulfur] {\tiny Ar};
\node[name=calcium, right= 2mm of argon] {\tiny Ca};
\node[name=cromum, right= 2mm of calcium] {\tiny Cr};
\node[name=manganese, right= 2mm of cromum] {\tiny Mn};
\node[name=ferrum, right= 2mm of manganese] {\tiny Fe};
\node[name=nikel, right= 2mm of ferrum] {\tiny Ni};
