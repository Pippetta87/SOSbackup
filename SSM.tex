...
\node[name=helium, right=1mm of hydrogen] {\tiny He};
\node[name=carbonium, right=1mm of helium.west] {\tiny C};
\node[name=nitrum, right=1mm of carbonium.west] {\tiny N};
\node[name=oxygen, right=1mm of nitrum.west] {\tiny O};
\node[name=neon, right=1mm of oxygen.west] {\tiny Ne};
\node[name=sodium, right=1mm of neon.west] {\tiny Na};
\node[name=magnesium, right=1mm of sodium.west] {\tiny Mg};
\node[name=alluminium, right=1mm of magnesium.west] {\tiny Al};
\node[name=silicium, right=1mm of alluminium.west] {\tiny Si};
\node[name=sulfur, right=1mm of silicium.west] {\tiny S};
\node[name=argon, right=1mm of sulfur.west] {\tiny Ar};
\node[name=calcium, right=1mm of argon.west] {\tiny Ca};
\node[name=cromum, right=1mm of calcium.west] {\tiny Cr};
\node[name=manganese, right=1mm of cromum.west] {\tiny Mn};
\node[name=ferrum, right=1mm of manganese.west] {\tiny Fe};
\node[name=nikel, right=1mm of ferrum.west] {\tiny Ni};
