...
Suppongo che la pressione del campo magnetico sia molto minore della pressione del gas nell'interno solare e che la correzione dovuta alla rotazione sia piccola; ci\'o \'e suffragato dalle misure del campoi magnetico superficiale e dalla piccola deviazione dalla forma sferica.
...
Considero il contributo alla pressione degli ioni, elettroni e fotoni, $P=P_I+P_R+P_e$, dove ho
\begin{align}
...
\node[anchor=north west] (opint) at (current page.north west) {\includegraphics[width=0.5\textwidth]{opcontrib-int}};
\node[anchor=north east] (opout) at ([shift={(0,3/40)}]current page.north east) {\includegraphics[width=0.5\textwidth]{opcontrib-out}};
\node[draw,anchor=north,label={[label distance=2mm]-90:Scattering \Pphoton\Pelectron},minimum size=5mm] (sc) at ([shift={(0,-2)}]current page.north) {};
\node[draw,label={[label distance=2mm]-90:ff},fill=black,minimum size=5mm,below=10mm of sc] (ff) {};
\node[draw,label={[label distance=2mm]-90:bb},fill=bb,minimum size=5mm,below=10mm of ff] (bb) {};
\node[draw,label={[label distance=2mm]-90:bf},fill=bf,minimum size=5mm,below=10mm of bb] (bf) {};

%\node[draw,fit={(sc) (bb) (bf) (ff)},minimum size=2cm] (legend) {};
...
\node at (current page.west) {\parbox{\textwidth}{\captionof{figure}{Importanza dei varii contributi all'opacit\'a nell'interno solare. Da \cite{bla11opacity}.}\label{fig:opacitycontrib} }};
