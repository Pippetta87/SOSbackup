...
\begin{wraptable}[10]{r}{0.3\textwidth}\label{wrap-tab:escreening}
...
display columns/0/.style={column name={GB}},
display columns/1/.style={column name={GDGC}},
display columns/2/.style={column name={SVH}},
display columns/3/.style={column name={DTDL}},
create on use/react/.style={create col/set list={reactions,
...
columns={react,GB,GDGC,SVH,DTDL}
},
