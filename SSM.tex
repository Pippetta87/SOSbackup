...
\node[draw,anchor=west,label={[label distance=2mm]-90:Scattering \Pphoton\Pelectron},minimum size=5mm,right below=7.5mm and 1cm of opint.east] (sc) {};
...
\begin{scope}[node distance=0.033,scale=0.3]
