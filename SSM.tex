...
\node[name=helium, right=4.4mm of hydrogen.west] {\tiny He};
\node[name=carbonium, right=4.4mm of helium.west] {\tiny C};
\node[name=nitrum, right=4.4mm of carbonium.west] {\tiny N};
\node[name=oxygen, right=4.4mm of nitrum.west] {\tiny O};
\node[name=neon, right=4.4mm of oxygen.west] {\tiny Ne};
\node[name=sodium, right=4.4mm of neon.west] {\tiny Na};
\node[name=magnesium, right=4.4mm of sodium.west] {\tiny Mg};
\node[name=alluminium, right=4.4mm of magnesium.west] {\tiny Al};
\node[name=silicium, right=4.4mm of alluminium.west] {\tiny Si};
\node[name=sulfur, right=4.4mm of silicium.west] {\tiny S};
\node[name=argon, right=4.4mm of sulfur.west] {\tiny Ar};
\node[name=calcium, right=4.4mm of argon.west] {\tiny Ca};
\node[name=cromum, right=4.4mm of calcium.west] {\tiny Cr};
\node[name=manganese, right=4.4mm of cromum.west] {\tiny Mn};
\node[name=ferrum, right=4.4mm of manganese.west] {\tiny Fe};
\node[name=nikel, right=4.4mm of ferrum.west] {\tiny Ni};
