...
\node[name=helium, right=5mm of hydrogen.west] {\tiny He};
\node[name=carbonium, right=5mm of helium.west] {\tiny C};
\node[name=nitrum, right=5mm of carbonium.west] {\tiny N};
\node[name=oxygen, right=5mm of nitrum.west] {\tiny O};
\node[name=neon, right=5mm of oxygen.west] {\tiny Ne};
\node[name=sodium, right=5mm of neon.west] {\tiny Na};
\node[name=magnesium, right=5mm of sodium.west] {\tiny Mg};
\node[name=alluminium, right=5mm of magnesium.west] {\tiny Al};
\node[name=silicium, right=5mm of alluminium.west] {\tiny Si};
\node[name=sulfur, right=5mm of silicium.west] {\tiny S};
\node[name=argon, right=5mm of sulfur.west] {\tiny Ar};
\node[name=calcium, right=5mm of argon.west] {\tiny Ca};
\node[name=cromum, right=5mm of calcium.west] {\tiny Cr};
\node[name=manganese, right=5mm of cromum.west] {\tiny Mn};
\node[name=ferrum, right=5mm of manganese.west] {\tiny Fe};
\node[name=nikel, right=5mm of ferrum.west] {\tiny Ni};
