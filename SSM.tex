...
\node[text depth=2pt,name=hydrogen, right=6mm of opint.south west] {\tiny H};
\node[text depth=2pt,name=helium, right=of hydrogen] {\tiny He};
\node[text depth=2pt,name=carbonium, right=of helium] {\tiny C};
\node[text depth=2pt,name=nitrum, right=of carbonium] {\tiny N};
\node[text depth=2pt,name=oxygen, right=of nitrum] {\tiny O};
\node[text depth=2pt,name=neon, right=of oxygen] {\tiny Ne};
\node[text depth=2pt,name=sodium, right=of neon] {\tiny Na};
\node[text depth=2pt,name=magnesium, right=of sodium] {\tiny Mg};
\node[text depth=2pt,name=alluminium, right=of magnesium] {\tiny Al};
\node[text depth=2pt,name=silicium, right=of alluminium] {\tiny Si};
\node[text depth=2pt,name=sulfur, right=of silicium] {\tiny S};
\node[text depth=2pt,name=argon, right=of sulfur] {\tiny Ar};
\node[text depth=2pt,name=calcium, right=of argon] {\tiny Ca};
\node[text depth=2pt,name=cromum, right=of calcium] {\tiny Cr};
\node[text depth=2pt,name=manganese, right=of cromum] {\tiny Mn};
\node[text depth=2pt,name=ferrum, right=of manganese] {\tiny Fe};
\node[text depth=2pt,name=nikel, right=of ferrum] {\tiny Ni};
