...
\node at (current page.north west) {\parbox{\textwidth}{\makeatletter
\def\@captype{figure}
\makeatother
\caption{Importanza dei varii contributi all'opacit\'a nell'interno solare. Da \cite{bla11opacity}.}}\label{opacitycontrib}}
