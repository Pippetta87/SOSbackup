...
\node[minimum size=2pt,name=hydrogen, right=6mm of opint.south west] {\tiny H};
\node[minimum size=2pt,name=helium, right=of hydrogen] {\tiny He};
\node[minimum size=2pt,name=carbonium, right=of helium] {\tiny C};
\node[minimum size=2pt,name=nitrum, right=of carbonium] {\tiny N};
\node[minimum size=2pt,name=oxygen, right=of nitrum] {\tiny O};
\node[minimum size=2pt,name=neon, right=of oxygen] {\tiny Ne};
\node[minimum size=2pt,name=sodium, right=of neon] {\tiny Na};
\node[minimum size=2pt,name=magnesium, right=of sodium] {\tiny Mg};
\node[minimum size=2pt,name=alluminium, right=of magnesium] {\tiny Al};
\node[minimum size=2pt,name=silicium, right=of alluminium] {\tiny Si};
\node[minimum size=2pt,name=sulfur, right=of silicium] {\tiny S};
\node[minimum size=2pt,name=argon, right=of sulfur] {\tiny Ar};
\node[minimum size=2pt,name=calcium, right=of argon] {\tiny Ca};
\node[minimum size=2pt,name=cromum, right=of calcium] {\tiny Cr};
\node[minimum size=2pt,name=manganese, right=of cromum] {\tiny Mn};
\node[minimum size=2pt,name=ferrum, right=of manganese] {\tiny Fe};
\node[minimum size=2pt,name=nikel, right=of ferrum] {\tiny Ni};
