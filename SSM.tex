...
\begin{align}
&\sigma(E)=\pi\lambdabar^2P_0(E)S(E)\intxt{La lunghezza d'onda di de Broglie relativa delle particelle descrive l'indeterminazione sulla posizione nell'urto di due particelle con momento relativo p}
&\lambdabar=\frac{\hbar}{p}=\frac{\hbar}{\sqrt{2mE}}\intxt{il fattore astrofisico $S(E)$ descrive l'interazione tra i due reagenti a livello nucleare ed \'e debolmente dipendente dall'energia lontano da risonanze, $P_0(E)=\exp{-2\pi\eta}$  descrive la probabilit\'a di attraversamento della barriera coulombiana con}
&\eta=\sqrt{\frac{m}{2}}\frac{Z_1Z_2e^2}{\hbar E\expy{\frac{1}{2}}}\intxt{Scrivo la sezione d'urto per i nuclei di carica $Z_1$, $Z_2$ e m massa ridotta:}
