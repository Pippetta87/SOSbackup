...
every head row/.style={
 before row={
 %\toprule &\multicolumn{4}{c|}{Attuale}%&\multicolumn{4}{c|}{Primordiale}
 %\\\midrule
 },
...
display columns/0/.style={column name={Reaction}},
display columns/1/.style={column name={$S(0)$}},
display columns/2/.style={column name={S'(0)$}},
display columns/3/.style={column name={$S''(0)$}},
display columns/4/.style={column name={$\delta S(E)$}},
...
\captionof{table}{Fattore astrofisico. Da \cite{adelberger11}.}
\end{table}
