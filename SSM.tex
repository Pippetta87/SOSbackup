...
\node[anchor=north east] (opout) at ([shift={(0,2.5-3/35)}]20,0) {\includegraphics[width=0.5\textwidth,keepaspectratio]{opcontrib-out-g}};
...
\node[anchor=north west] at ([shift={(0,-20.5)}]0,0) {\parbox{\textwidth}{\captionof{figure}{Importanza dei varii contributi all'opacit\'a nell'interno solare. Da \cite{bla11opacity}.}\label{fig:opacitycontrib} }};
