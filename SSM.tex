...
\begingroup
\color{midnightblue}
Modello stellare: configurazione di equilibrio. Natura oscillazioni attorno alla struttura di equilibrio.
\endgroup
...
\begingroup
\color{midnightblue}
Considero un gusco sferico di gas su cui agiscono gravit\'a e pressione termica: simmetria sferica.
...
\endgroup %% fine conservazione energia interna spostato nella prima sottosezione
