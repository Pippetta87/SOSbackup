...
\begin{adjustbox}{tabular=|ccc|max width=0.45\textwidth,keepaspectratio,caption={Reaction rate \cite{adelberger2011solar}.},float=table}
\hline
{Reaction} & {$S(0) (keVb)$} & {\parbox{2cm}{\centering Gamow peak uncertainty (\%)}}\\
\hline
...
\begin{wraptable}[10]{l}[10pt]{7.5cm}\label{wrap-tab:escreening}
