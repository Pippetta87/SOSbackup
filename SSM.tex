...
}{(7,-14)}{0.5\textwidth}{Importanza dei varii contributi all'opacit\'a nell'interno solare.}
...
\begin{figure*}[!h]
    \centering
  \begin{subfigure}[t]{0.5\textwidth}
        \includegraphics[width=0.5\textwidth]{ReactionsH}
        \caption{Reazioni di fusione H-He: catena PP e ciclo CNO.}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.5\textwidth}
        \includegraphics[width=0.5\textwidth]{watt-PPvsCNO}
