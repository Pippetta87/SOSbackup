...
La correzione alla pressione dovuta alle interazioni coulombiane raggiunge il picco relativo nelle regioni di ionizzazione parziale di idrogeno ed elio, come illustrato da \ref{fig:degenelectrocorrection}.
...
~
\begin{subfigure}[t]{0.5\textwidth}
        \includegraphics[width=0.5\textwidth,keepaspectratio]{gamma1eos}\label{gamma1eos}
        \caption{Andamento di $\Gamma_1$. Da \cite{trampedach2006synoptic}}
\end{subfigure}
\end{figure}

Come illustrato in \ref{fig:gamma1eos}, per entrambe $\Gamma_1\approx\midfrac{5}{3}$ nell'interno solare e maggiori deviazioni si hanno nelle regioni di ionizzazione parziale degli elementi in particolare di idrogeno ed elio.
