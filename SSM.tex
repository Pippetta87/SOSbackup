...
\node[name=hydrogen, right= 2mm of opint.south west] {\tiny H};
\node[name=helium, right= 1mm of hydrogen] {\tiny He};
\node[name=carbonium, right=1mm of helium] {\tiny C};
\node[name=nitrum, right= 1mm of carbonium] {\tiny N};
\node[name=oxygen, right= 1mm of nitrum] {\tiny O};
\node[name=neon, right= 1mm of oxygen] {\tiny Ne};
\node[name=sodium, right= 1mm of neon] {\tiny Na};
\node[name=magnesium, right= 1mm of sodium] {\tiny Mg};
\node[name=alluminium, right= 1mm of magnesium] {\tiny Al};
\node[name=silicium, right= 1mm of alluminium] {\tiny Si};
\node[name=sulfur, right= 1mm of silicium] {\tiny S};
\node[name=argon, right= 1mm of sulfur] {\tiny Ar};
\node[name=calcium, right=1mm of argon] {\tiny Ca};
\node[name=cromum, right=1mm of calcium] {\tiny Cr};
\node[name=manganese, right=1mm of cromum] {\tiny Mn};
\node[name=ferrum, right=1mm of manganese] {\tiny Fe};
\node[name=nikel, right=1mm of ferrum] {\tiny Ni};
