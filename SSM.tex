...
\node[anchor=south west] (opint) at ([shift={(0,2.5)}]current page.south west) {\includegraphics[width=0.55\textwidth,keepaspectratio]{opcontrib-int-g}};
\node[anchor=south east] (opout) at ([shift={(0,2.5-3/35)}]current page.south east) {\includegraphics[width=0.55\textwidth,keepaspectratio]{opcontrib-out-g}};
