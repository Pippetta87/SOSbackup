...
\begin{scope}[node distance=-1.25mm,scale=0.65]
\node[name=hydrogen, right=5mm of opint.south west] {\tiny H};
\node[name=helium, right=of hydrogen] {\tiny He};
\node[name=carbonium, right=of helium] {\tiny C};
\node[name=nitrum, right=of carbonium] {\tiny N};
\node[name=oxygen, right=of nitrum] {\tiny O};
\node[name=neon, right=of oxygen] {\tiny Ne};
\node[name=sodium, right=of neon] {\tiny Na};
\node[name=magnesium, right=of sodium] {\tiny Mg};
\node[name=alluminium, right=of magnesium] {\tiny Al};
\node[name=silicium, right=of alluminium] {\tiny Si};
\node[name=sulfur, right=of silicium] {\tiny S};
\node[name=argon, right=of sulfur] {\tiny Ar};
\node[name=calcium, right=of argon] {\tiny Ca};
\node[name=cromum, right=of calcium] {\tiny Cr};
\node[name=manganese, right=of cromum] {\tiny Mn};
\node[name=ferrum, right=of manganese] {\tiny Fe};
\node[name=nikel, right=of ferrum] {\tiny Ni};
