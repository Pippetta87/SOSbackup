...
\begin{subfigure}[r]{0.5\textwidth}
        \includegraphics[width=0.5\textwidth,keepaspectratio]{ionfraction}
        \caption{Profilo radiale della popolazione dei diversi gradi di ionizzazione per $\cel{He}{4}{}{}$, CNO, $\cel{Ne}{20}{}{}$, $\cel{Fe}{56}{}{}$. Da \cite{}.}
    \end{subfigure}
~
\begin{subfigure}[r]{0.5\textwidth}
        \includegraphics[width=0.5\textwidth,keepaspectratio]{gamma1eos}
        \caption{Andamento di $\Gamma_1$. Da \cite{villante2014chemical}}
    \end{subfigure}
\end{figure}
