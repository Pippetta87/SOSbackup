...
\node[draw,label={[label distance=5mm]-90:Scattering \Pphoton\Pelectron},minimum size=5mm] (sc) at (4,4) {};
\node[draw,label={[label distance=5mm]90:ff},fill=black,minimum size=5mm] (ff) at (8,4) {};
\node[draw,label={[label distance=5mm]30:bb},fill=bb,minimum size=5mm] (bb) at (4,2) {};
\node[draw,label={[label distance=5mm]30:bf},fill=bf,minimum size=5mm] (bf) at (8,2) {};
