...
\item Diffusione dovuta al gradiente di concentrazione relativa $c_i=\frac{n_i}{n}$.
...
\begin{align}
&K_T=\frac{C-1}{nkD_{12}}\frac{x_1m_1\lambda_2-x_2m_2\lambda_1}{m_1+m_2},\ D_{12}=\frac{kT}{m_{12}n\overline{\nu}}(\text{mean collision frequency $n\overline{\nu}$})\\
&D_T\approx D_{12}K_T=(C-1)\frac{T}{P}\frac{x_1m_1\lambda_2-x_2m_2\lambda_1}{m_1+m_2}&\intertext{C dipende da T e dalla legge di interazione delle molecole di specie diverse}\\
&V=-\frac{D_T\nabla T}{x_1x_2T}=(C-1)\frac{n_1m_1\vec{q}_2-n_2m_2\vec{q}_1}{n_1n_2kT(m_1+m_2)},\ \vec{q}_1=-\lambda_i\nabla T
\end{align}
