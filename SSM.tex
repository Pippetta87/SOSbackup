...
\node[name=helium, right= 10px of hydrogen] {\tiny He};
\node[name=carbonium, right=10px of helium] {\tiny C};
\node[name=nitrum, right= 10px of carbonium] {\tiny N};
\node[name=oxygen, right= 10px of nitrum] {\tiny O};
\node[name=neon, right= 10px of oxygen] {\tiny Ne};
\node[name=sodium, right= 10px of neon] {\tiny Na};
\node[name=magnesium, right= 10px of sodium] {\tiny Mg};
\node[name=alluminium, right= 1opx of magnesium] {\tiny Al};
\node[name=silicium, right= 10px of alluminium] {\tiny Si};
\node[name=sulfur, right= 10px of silicium] {\tiny S};
\node[name=argon, right= 10px of sulfur] {\tiny Ar};
\node[name=calcium, right=10px of argon] {\tiny Ca};
\node[name=cromum, right=10px of calcium] {\tiny Cr};
\node[name=manganese, right=10px of cromum] {\tiny Mn};
\node[name=ferrum, right=10px of manganese] {\tiny Fe};
\node[name=nikel, right=10px of ferrum] {\tiny Ni};
