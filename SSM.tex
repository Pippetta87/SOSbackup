...
\node[draw,label={[label distance=2mm]-90:Scattering \Pphoton\Pelectron},minimum size=5mm] (sc) at (2,-6) {};
\node[draw,label={[label distance=2mm]-90:ff},fill=black,minimum size=5mm] (ff) at (4,-6) {};
\node[draw,label={[label distance=2mm]-90:bb},fill=bb,minimum size=5mm] (bb) at (6,-6) {};
\node[draw,label={[label distance=2mm]-90:bf},fill=bf,minimum size=5mm] (bf) at (8,-6) {};

\node[draw,fit={(sc) (bb) (bf) (ff)},minimum size=1cm] (legend) {};
...
}{(-2,-8)}{\textwidth}{Importanza dei varii contributi all'opacit\'a nell'interno solare. Da \cite{bla11opacity}.}
