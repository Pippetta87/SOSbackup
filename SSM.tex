...
\node[name=carbonium, right=0.05mm of helium] {\tiny C};
\node[name=nitrum, right= 0.05mm of carbonium] {\tiny N};
\node[name=oxygen, right= 0.05mm of nitrum] {\tiny O};
\node[name=neon, right= 0.05mm of oxygen] {\tiny Ne};
\node[name=sodium, right= 0.05mm of neon] {\tiny Na};
\node[name=magnesium, right= 0.05mm of sodium] {\tiny Mg};
\node[name=alluminium, right= 0.05mm of magnesium] {\tiny Al};
\node[name=silicium, right= 0.05mm of alluminium] {\tiny Si};
\node[name=sulfur, right= 0.05mm of silicium] {\tiny S};
\node[name=argon, right= 0.05mm of sulfur] {\tiny Ar};
\node[name=calcium, right=0.05mm of argon] {\tiny Ca};
\node[name=cromum, right=0.05mm of calcium] {\tiny Cr};
\node[name=manganese, right=0.05mm of cromum] {\tiny Mn};
\node[name=ferrum, right=0.05mm of manganese] {\tiny Fe};
\node[name=nikel, right=0.05mm of ferrum] {\tiny Ni};
