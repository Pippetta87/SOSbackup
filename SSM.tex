...
\begin{align}
&v_H-v_{He}=-D_{HHe}[\frac{1}{c_1c_2}\PDy{r}{c_1}+\frac{m_2-m_1}{c_1m_1+c_2m_2}\frac{1}{P}\PDy{r}{P}+\frac{K_T}{n_1n_2}\frac{1}{T}\PDy{r}{T}]&\intertext{per potenziale coulombiano}\nonumber\\
&[D_{12}]_1=\left.\frac{3}{16n}(\frac{2kT(m_H+m_{He})}{\pi m_1m_2})\expy{\frac{1}{2}}(\frac{2kT}{Z_1Z_2e^2})^2\middle/\ln{(1+\frac{4\lambda kT}{Z_1Z_2e^2})}\right.,\ d=
\end{align}
