...
\node (opint) at (0,0) {\includegraphics[width=0.5\textwidth]{opcontrib-int}};
\node (opout) at (8,0) {\includegraphics[width=0.5\textwidth]{opcontrib-out}};
...
%\node at (current page.north west) {\parbox{\textwidth}{a}};
%\captionof{figure}{Importanza dei varii contributi all'opacit\'a nell'interno solare. Da \cite{bla11opacity}.}\label{fig:opacitycontrib} }};
