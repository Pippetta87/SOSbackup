...
\begin{workout}[stati di scattering-ionizzazione da pressione]
...
\begin{workout}[Parametri reazioni nucleari e incertezze schermaggio elettronico]
...
\node[anchor=north west] (opint) at ([shift={(0,0)}]0,0) {\includegraphics[width=0.45\textwidth,keepaspectratio]{opcontrib-int-g}};
\node[anchor=north east] (opout) at ([shift={(0,0-3/35)}]0,0) {\includegraphics[width=0.45\textwidth,keepaspectratio]{opcontrib-out-g}};
...
\begin{workout}[Inertezze sistematiche su $Z/X$ e abbondanza relativa elementi]
...
\begin{workout}[Incertezze nel reaction rates]
...
I modi dipendono da $P(r)$, $\rho(r)$, $g(r)$ e $\Gamma_1(r)$ e poich\'e queste quantit\'a sono legate dalle equazioni della struttura stellare \'e i modi adiabatici sono determinati da 2 combinazioni indipendentidi queste grandezze; data la natura prevalentemente acustica delle oscillazioni la osservabile principale \'e
\begin{equation}
c_s^2=\Gamma_1\frac{P}{\rho}=\Gamma_1U
\end{equation}
dove $U$ \'e la velocit\'a di propagaziopne di un'onda acustica isoterma.

La composizione chimica, in particolare  la frazione di elio, sono ricavate da $\Gamma_1$.
...
Composizione zona convettiva omogenea:  $\Gamma_1$ in regioni di ionizzazione H-He
