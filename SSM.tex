...
\begin{figure}[!ht]
\begin{subfigure}[r]{0.5\textwidth}\label{fig:soundspeedccm}
        \includegraphics[width=0.99\textwidth,keepaspectratio]{soundspeed}
...
Il buon accordo tra il profilo di $c_s$ determinato eliosismologicamente e calcolato da un modello solare (\subref{fig:soundspeedccm}) giustifica l'uso del modello per calcolare il comportamento dei modi solari che come iluustrer\'o nell'ultima parte permette di determinare il profilo di $\rho$ e $c_s$ in miglior accordo con le osservazioni.
