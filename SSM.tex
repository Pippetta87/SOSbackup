...
I modelli stellari devono contenere una descrizione accurata del plasma solare, in particolare \'e necessario conoscere l'equazione di stato, le propriet\'a di trasmisione della radiazione e l'efficienza delle reazioni di fusione. Inoltre per alcuni meccanismi fisici, come ad esempio la convezione negli esterni stellari, non esiste ancora una teoria completa quindi si introducono dei parametri nel modello scelti in maniera da riprodurre pi\'u accuratamente possibile la posizione della stella nel diagramma di \hr{}, definito da luminosit\'a e temperatura efficace.
...
\end{equation}
e dalla conservazione dell'energia $\TDy{t}{W}+L=0$ segue che durante la fase di contrazione prima dell'inizio della sequenza principale met\'a dell'energia gravitazionale viene spesa per aumentare l'energia interna e met\'a in luminosit\'a:
\begin{equation}
...
\begin{workout}[Equazione trasporto radiatiovo in condizioni di equilibrio termico locale]
\begin{equation}
\frac{dI_{\nu}}{\rho\,ds}=\kappa_{\nu}B_{\nu}(T)-\kappa_{\nu}I_{\nu}
\end{equation}
\end{workout}
...
\begin{workout}[Dimensioni $\Delta E_G$]
