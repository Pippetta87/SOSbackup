...
\end{subfigure}
~
\begin{subfigure}[t]{0.5\textwidth}\label{fig:gamma1eos}
        \includegraphics[width=0.8\textwidth,keepaspectratio]{gamma1eos}\label{gamma1eos}
...
\node[anchor=north west] (opint) at ([shift={(1.5,0)}]0,0) {\includegraphics[height=0.35\textheight,keepaspectratio]{opcontrib-int-g}};
\node[anchor=north east] (opout) at ([shift={(1.5,0-3/35)}]0,0) {\includegraphics[height=0.35\textheight,keepaspectratio]{opcontrib-out-g}};
\begin{scope}[scale=0.7]
\node[draw,anchor=north,label={[label distance=2mm]-90:Scattering \Pphoton\Pelectron},minimum size=5mm,right=5mm of opout.east] (sc) {};
...
\node[anchor=north west below=5mm of opint.south west] at ([shift={(0,-12.5)}]0,0) {\parbox{\textwidth}{\captionof{figure}{Importanza dei varii contributi all'opacit\'a nell'interno solare. Da \cite{bla11opacity}.}\label{fig:opacitycontrib} }};
