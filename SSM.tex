...
\node[draw,right] (sc) at (4,4) {Scattering \Pphoton\Pelectron};
\node[draw,right,fill=black] (ff) at (8,4) {ff};
\node[draw,right,fill=bb] (bb) at (4,2) {bb};
\node[draw,right,fill=bf] (bf) at (8,2) {bf};

\node[draw,fit={(sc),(bb),(bf),(ff)}] (legend) at (8,8) {};
