...
\node[right = 5mm of opint] (opout) {\includegraphics[width=0.5\textwidth]{opcontrib-out}};
\node[draw,label={[label distance=2mm]-90:Scattering \Pphoton\Pelectron},minimum size=5mm] (sc) at (2,-7) {};
\node[draw,label={[label distance=2mm]-90:ff},fill=black,minimum size=5mm] (ff) at (4,-7) {};
\node[draw,label={[label distance=2mm]-90:bb},fill=bb,minimum size=5mm] (bb) at (6,-7) {};
\node[draw,label={[label distance=2mm]-90:bf},fill=bf,minimum size=5mm] (bf) at (8,-7) {};
...
\node at (current page.north west) {\parbox{5mm}{\captionof{figure}{Importanza dei varii contributi all'opacit\'a nell'interno solare. Da \cite{bla11opacity}.}\label{fig:opacitycontrib} }};
