...
\begingroup
\color{midnightblue}
\'E possibile che parte dell'energia interna di una stella vada ad alimentare un comportamento oscillatorio attorno alla configurazione di equilibrio descritta tramite un modello stellare. Nei capitoli successivi descrivo la configurazione di equilibrio del Sole e le incertezze nella descrizione fisica del modelo.
...
Al limite bb bf ff electron scattering.
\endgroup
...
\section{''Accuratezza del modello solare standard''.}
...
\subsection{Input fisici del MSS}
