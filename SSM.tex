...
Schematizzo i processi di diffusione , considerando separatamente la diffusione di $\cel{H}{1}{}{}-\cel{He}{4}{}{}$ e degli elementi pesanti.
...
dove sono presenti il contributo alla velocit\'a di diffusione relativa del
...
\item Sedimentazione gravitazionale. La gravit\'a tende a concentrare gli elementi pi\'u pesanti verso il centro, le interazioni elettromagnetiche mantengono gli elettroni ancorati ai nuclei. La forza per unit\'a di volume agente sulle particelle di specie i \'e
...
\item Diffusione termica. Le particelle pi\'u cariche e pi\'u pesanti diffondono verso le zone pi\'u calde: infatti in presenza di un gradiente termico si ha una diversa probabilit\'a di trasferimento di momento nella direzione del gradiente; la sezione d'urto coulombiana dipende dalla velocit\'a relativa $\propto v\expy{-4}$ (probabilit\'a di collisione $\propto v\expy{-3}$).
