...
\begin{scope}[node distance=-1.2mm,scale=0.5]
\node[minimum size=2mm,name=hydrogen, right=6mm of opint.south west] {\tiny H};
\node[minimum size=2mm,name=helium, right=of hydrogen] {\tiny He};
\node[minimum size=2mm,name=carbonium, right=of helium] {\tiny C};
\node[minimum size=2mm,name=nitrum, right=of carbonium] {\tiny N};
\node[minimum size=2mm,name=oxygen, right=of nitrum] {\tiny O};
\node[minimum size=2mm,name=neon, right=of oxygen] {\tiny Ne};
\node[minimum size=2mm,name=sodium, right=of neon] {\tiny Na};
\node[minimum size=2mm,name=magnesium, right=of sodium] {\tiny Mg};
\node[minimum size=2mm,name=alluminium, right=of magnesium] {\tiny Al};
\node[minimum size=2mm,name=silicium, right=of alluminium] {\tiny Si};
\node[minimum size=2mm,name=sulfur, right=of silicium] {\tiny S};
\node[minimum size=2mm,name=argon, right=of sulfur] {\tiny Ar};
\node[minimum size=2mm,name=calcium, right=of argon] {\tiny Ca};
\node[minimum size=2mm,name=cromum, right=of calcium] {\tiny Cr};
\node[minimum size=2mm,name=manganese, right=of cromum] {\tiny Mn};
\node[minimum size=2mm,name=ferrum, right=of manganese] {\tiny Fe};
\node[minimum size=2mm,name=nikel, right=of ferrum] {\tiny Ni};
