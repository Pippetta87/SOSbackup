...
\node[anchor=north west] (opint) at (current page.north west) {\includegraphics[width=0.5\textwidth]{opcontrib-int-g}};
\node[anchor=north east] (opout) at ([shift={(0,-3/35)}]current page.north east) {\includegraphics[width=0.5\textwidth]{opcontrib-out-g}};
