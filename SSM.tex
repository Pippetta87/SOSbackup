...
\end{subfigure}
~
\begin{subfigure}[t]{0.45\textwidth}\label{fig:gamma1eos}
        \includegraphics[width=0.95\textwidth,keepaspectratio]{gamma1eos}\label{gamma1eos}
...
\node[draw,anchor=west,label={[label distance=2mm]-90:Scattering \Pphoton\Pelectron},minimum size=5mm,right=5mm of opout.east] (sc) {};
...
\begin{scope}[node distance=0.35]
\node[name=hydrogen, right= 6mm of opint.south west] {\tiny H};
...
\node[anchor=north west, below=1mm of opint.south west] {\parbox{\textwidth}{\captionof{figure}{Importanza dei varii contributi all'opacit\'a nell'interno solare; composizione GS98. Da \cite{bla11opacity}.}\label{fig:opacitycontrib} }};
