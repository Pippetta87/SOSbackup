...
\node[anchor=north east] (opout) at (current page.north east) {\includegraphics[width=0.5\textwidth]{opcontrib-out}};
\node[draw,anchor=north,label={[label distance=2mm]-90:Scattering \Pphoton\Pelectron},minimum size=5mm] (sc) at (current page.north) {};
