...
every head row/.style={
 before row={\toprule &\multicolumn{4}{c}{Attuale}\midrule&\multicolumn{4}{c}{Primordiale}\\},
...
\captionof{figure}{Metallicit\'a osservata e iniziale. Da\cite{asplund2009chemical}.}
\end{table}
