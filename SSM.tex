...
\node (opint) at (8,5) {\includegraphics[width=0.5\textwidth]{opcontrib-int}};
\node (opout) at (8,-7) {\includegraphics[width=0.5\textwidth]{opcontrib-out}};
\node (opcontrib) at (-2,6) {\parbox{0.5\textwidth}{I fenomeni che contribuiscono all'opacit\'a nel Sole sono:
...
}{(0,-13)}{9cm}{Importanza dei varii contributi all'opacit\'a nell'interno solare. Da \cite{bla11opacity}.}
