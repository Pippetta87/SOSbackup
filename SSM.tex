...
\node[anchor=north west] (opint) at (-10,0) {\includegraphics[height=0.35\textheight,keepaspectratio]{opcontrib-int-g}};
\node[anchor=west,right=2cm of opint.east] (opout) {\includegraphics[height=0.35\textheight,keepaspectratio]{opcontrib-out-g}};
\begin{scope}[scale=0.7]
\node[draw,anchor=west,label={[label distance=2mm]-90:Scattering \Pphoton\Pelectron},minimum size=5mm,right=7.5mm of opint.east] (sc) {};
...
\begin{scope}[node distance=0.1,scale=0.8]
...
\node[anchor=north west, below=1mm of opint.south west,draw] {};
