...
\begin{scope}[local bounding box=astrofactor,scale=0.03,transform shape]
\matrix[matrix of nodes,column sep={83pt,between origins},row
    sep={22pt,between origins}] (s)
  {
...
%14N(p,7)150 XI.A 1.66 \pm 0.12 (-3.3 \pm 0.2) x 10-3 b (4.4 \pm 0.3) x 10-5 a \pm 7.2
  ...
  \draw[orange]({$(s-1-1)!.5!(s-1-2)$} |- s.north) -- ({$(s-1-1)!.5!(s-1-2)$} |- s.south);
    \draw[blue]({$(s-1-2)!.5!(s-1-3)$} |- s.north) -- ({$(s-1-2)!.5!(s-1-3)$} |- s.south);

  \node[fit=(s-1-1.south) (s-1-2.south) (s-1-3.south),inner sep=0pt] (R2) {};
\draw[green!50!black] (R2.south -| s.west) -- (R2.south -| s.east);

 \end{scope}
 
\node (pep) at ($(s.south)+(47mm,-2mm)$) {\parbox{\textwidth}{$\scriptstyle II: R(p\Pelectron p)=1.102(1\pm0.01)10^{-4}\midfrac{\rho}{\mu_e}T_6\expy{-1/2}[1+0.002(T_6-16)]R(pp)$}};
\node[below=0.1mm of pep] (ec) {\parbox{\textwidth}{$\scriptstyle I: R(\cel{Be}{7}{}{}(\Pelectron,\Pnue)\cel{Li}{7}{}{})=5.6(1\pm0.02)10^{-9}\midfrac{\rho}{\mu_e}T_6\expy{-1/2}[1+0.004(T_6-16)]\si{\per\second}$}};
 
\node[below=0.1mm of ec] (captions) {\parbox{\textwidth}{\captionof{figure}{Fattore astrofisico reazioni catena PP}}};

\begin{scope}[local bounding box=ppchain,shift={($(astrofactor.east)+(15mm,25mm)$)},scale=0.7,transform shape]
...
\node[anchor=north west]  at ($(ppchain.south)+(-30mm,-1mm)$) {\parbox{\textwidth}{\captionof{figure}{Reazioni catena PP. Da \cite{adelberger2011solar}.}}};
